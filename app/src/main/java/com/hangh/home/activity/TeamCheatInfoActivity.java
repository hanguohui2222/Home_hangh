...
import com.hangh.home.widget.CustomDialog;
import com.hangh.home.widget.OptionItemView;
...
public class TeamCheatInfoActivity extends BaseActivity {
    ...
    @Bind(R.id.oivTeamName)
    OptionItemView mOivTeamName;
    @Bind(R.id.tvAnnouncement)
    TextView mTvAnnouncement;
    @Bind(R.id.vLineTeamManage)
    View mVLineTeamManage;
    @Bind(R.id.oivTeamManage)
    OptionItemView mOivTeamManage;
    @Bind(R.id.oivNickNameInTeam)
    OptionItemView mOivNickNameInTeam;
    @Bind(R.id.llShowNickName)
